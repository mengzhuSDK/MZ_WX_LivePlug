const {
  op
} = require("../../../mzinterface/mzimage/voice_live_am");
...
Page({
  ...
  data: {
    ...
    // 当前登录用户
    currentUser: {
      uniqueId: 'mengzhu_xiaomengxin_wx',
      nickName: '盟主_小萌新wx',
    ...
    settingCheck: {
      ...
      defClick: false,
      def: 'SD',
      defImage: '../../../mzinterface/mzimage/vx_setting_def1.png',
    },
  ...
  onLoad: function (options) {
    ...
    if (app.globalData.userInfo) {
      _this.setData({
        'currentUser.uniqueId': app.globalData.userInfo.uniqueId || "mengzhu_xiaomengxin_wx",
        'currentUser.nickName': app.globalData.userInfo.nickName || "盟主小萌新wx",
        'currentUser.avatarUrl': app.globalData.userInfo.avatarUrl || "https://s1.zmengzhu.com/user/images/user-default-image.png",
        'anchorInfo.anchorName': app.globalData.userInfo.nickName || "盟主小萌新wx",
  ...
  getParams(options) {
    ...
    this.setData({
      ...
      var def = '';
      var defImage = '../../../mzinterface/mzimage/vx_setting_def1.png'
      if (this.data.beautfy_level == 1) {
        def = "SD"
        defImage = '../../../mzinterface/mzimage/vx_setting_def1.png'
      } else if (this.data.beautfy_level == 2) {
        def = "HD"
        defImage = '../../../mzinterface/mzimage/vx_setting_def2.png'
      } else if (this.data.beautfy_level == 3) {
        def = "FHD"
        defImage = '../../../mzinterface/mzimage/vx_setting_def3.png'
      }
  ...
  settingClick(e) {
    ...
    if (type == "SD") {
      this.setData({
        ...
        "settingCheck.defImage": '../../../mzinterface/mzimage/vx_setting_def1.png',
    ...
    if (type == "HD") {
      this.setData({
        "settingCheck.def": type,
        "settingCheck.defImage": '../../../mzinterface/mzimage/vx_setting_def2.png',
        "settingCheck.defClick": false,
      } ,() =>{
        this.pushReset()
      })
    ...
    if (type == "FHD") {
      this.setData({
        "settingCheck.def": type,
        "settingCheck.defImage": '../../../mzinterface/mzimage/vx_setting_def3.png',
        "settingCheck.defClick": false,
      } ,() =>{
        this.pushReset()
      })
